          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Azure / AWS / GCP</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">YOLOv8 &amp; ByteTrack</div>
                <div className="what-tags">Streamlit / Gradio</div>
                <div className="what-tags">Docker</div>
                <div className="what-tags">RAG &amp; LLM agents</div>
                <div className="what-tags">Generative AI (OCI)</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
