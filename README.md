...
Landing → About → What I Do → Career & Education → Work (4 live demos) →
...
Visual design and 3D scaffolding adapted from
[**Akash Malhotra’s open-source 3D portfolio template**](https://github.com/akashrmalhotra/3d-portfolio)
(MIT). All copy, projects, branding, generated tech-ball textures and
project preview cards are original work for Sree Reethika Kasanagottu.
